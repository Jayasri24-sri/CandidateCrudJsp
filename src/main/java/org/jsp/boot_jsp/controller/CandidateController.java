...
import org.jsp.boot_jsp.service.CandidateService;
...
public class CandidateController {
    ...
    @PostMapping("/insert")
    public String insert(Candidate candidate, ModelMap map) {
        return service.save(candidate, map);
    }
    ...
    public String update(Candidate candidate, ModelMap map) {
        return service.update(candidate, map);
    }
}
